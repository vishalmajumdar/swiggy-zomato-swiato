      ...
      <div className="mx-auto w-full max-w-7xl px-8">
        <div className="grid grid-cols-1 justify-between items-center gap-4 md:grid-cols-2">
          <div>
            ...
            <Typography
              variant="h6"
              className="mb-3 font-playball tracking-wider text-xs text-theme-color flex items-center justify-center lg:justify-start"
            >
              Swiggy + Zomato
            </Typography>
          </div>
            ...
            {LINKS.map(({ title, items }) => (
              <ul key={title}>
                <Typography
                  variant="small"
                  color="blue-gray"
                  className="font-poppins mb-3 font-medium opacity-40"
                >
                  {title}
                </Typography>
                {items.map((link) => (
        ...
        <div className="mt-6 flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
          ...
          <div className="flex gap-4 text-blue-gray-900 sm:justify-center">
            ...
            >
              <svg
                className="h-5 w-5 hover:text-theme-color transition-transform hover:scale-105 duration-500"
                fill="currentColor"
                viewBox="0 0 24 24"
                aria-hidden="true"
              >
